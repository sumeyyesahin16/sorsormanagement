                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body text-center">
                            <h3 class="text-primary">Total Videos Statistics</h3>
                        </div>
                    </div>
                </div><!-- Col Header Ends -->
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
                    <div class="card">
                        <div class="card-body text-center statistics-info">
                            ...
                            <h6 class="mt-4 mb-1">Videos' Count</h6>
                            <h2 class="mb-2 number-font">{{$video_share_count}}</h2>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
                    <div class="card">
                        <div class="card-body text-center statistics-info">
                            ...
                            <h6 class="mt-4 mb-1">Videos' Comments' Count</h6>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
                    <div class="card">
                        <div class="card-body text-center statistics-info">
                            ...
                            <h6 class="mt-4 mb-1">Videos' Likes' Count</h6>
                            <h2 class="mb-2 number-font">
                                {{$video_like}}
                            </h2>
                            <p class="text-muted"></p>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
                    <div class="card">
                        <div class="card-body text-center statistics-info">
                            ...
                            <h6 class="mt-4 mb-1">Videos' Views' Count</h6>
                            <h2 class="mb-2 number-font">
                                AAAA
                            </h2>
                            <p class="text-muted"></p>
